...
mongoose.connect('mongodb+srv://admin:admin@authcluster.kobte.mongodb.net/dgpredb?retryWrites=true&w=majority', {
  useNewUrlParser: true,
  useUnifiedTopology: true,
  useCreateIndex: true
});
//mongodb+srv://admin:admin@authcluster.kobte.mongodb.net/dgpredb?retryWrites=true&w=majority
